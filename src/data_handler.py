...
class Dataset:
    ...
    def __add__(self, other):
        ...
        combined_info = {**self.__info, **other.__info}
        new_dataset = Dataset(self.__path)
        new_dataset.data = combined_data
        new_dataset.__info = combined_info
        return new_dataset
    ...
    def add_unbalance(self):
        if self.__info["unbalance"] == "none":
            self.data["unbalance"] = False
        else:
            self.data["unbalance"] = True    
